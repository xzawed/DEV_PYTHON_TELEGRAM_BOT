...
let virtual-env = "K:\DEVELOPMENT\PYTHON_SAMPLE\DEV_PYTHON_BOT\Practics\venv"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "K:\DEVELOPMENT\PYTHON_SAMPLE\DEV_PYTHON_BOT\Practics\venv\Scripts\deactivate.nu"
